...
if (strlen($_SESSION['login']) == 0) {
  ...
  <head>
    ...
    <title>University Query Tracking System | Dashboard</title>
      ...
      <section id="main-content">
        <section class="wrapper">
          ...
          <div class="row">
            <div class="col-lg-9 main-chart">
              ...
              <div class="col-md-2 col-sm-2 box0">
                ...
                <p><?php echo htmlentities($num1); ?> Issues not processed yet</p>
              </div>
            <?php } ?>
            ...
            <div class="col-md-2 col-sm-2 box0">
              ...
              <p><?php echo htmlentities($num1); ?> Issues Status in process</p>
            </div>
          <?php } ?>
          ...
          <div class="col-md-2 col-sm-2 box0">
            ...
            <p><?php echo htmlentities($num1); ?> Issues have been resolved</p>
          </div>
